...
function initialize() {
    ...
    if (savedLocations) {
        ...
        //try to geolocate, otherwise set city to Tampa
...
function success(position) {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?" + lat + "&lon=" + lon + "&appid=" + apiKey;
    $.ajax({
        url: queryURL,
        method: "GET"
...
function getForecast(city) {
    //get 5 day forecast
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?id=" + city + "&appid=" + apiKey;
    $.ajax({
        url: queryURL,
        method: "GET"
    }).then(function (response) {
